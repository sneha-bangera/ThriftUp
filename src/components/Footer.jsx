import { Instagram, Twitch, Facebook, Twitter,  } from "lucide-react";
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 text-center sm:text-left">
          <div>
            ...
            <div className="flex justify-center sm:justify-start space-x-4 mt-4">
              {[Instagram, Facebook, Twitch].map((Icon, index) => (
                <div
                  key={index}
          ...
          <div>
            ...
            <ul className="space-y-2 text-deep-plum">
              <li><a href="/shop">Buy Products</a></li>
              <li><a href="/dashboard">Sell Products</a></li>
